import { g as C, b as I, p as R } from "./unocss_DW1qlqnA.js";
import { V as h, y as D, S as G, U as M, W as V } from "./vue_X8qYN8tJ.js";
import { r as q, a as P, b as N, c as A } from "./rehype-plugins_DxbMbxbl.js";
import { m as W } from "./gray-matter_DG9-Aqkk.js";
import { m as U, g as L, a as z, b as Y, d as _, e as Q, f as J, h as K, i as X } from "./micromark_56cY9bNe.js";
...
var ne = {
  ...
  '"': "&quot;",
  "'": "&#39;"
}, ie = oe(ne), ae = typeof global == "object" && global && global.Object === Object && global, se = typeof self == "object" && self && self.Object === Object && self, de = ae || se || Function("return this")(), g = de.Symbol;
function ce(e, r) {
  for (var t = -1, o = e == null ? 0 : e.length, n = Array(o); ++t < o; )
    n[t] = r(e[t], t, e);
  return n;
}
var ue = Array.isArray, w = Object.prototype, ge = w.hasOwnProperty, fe = w.toString, l = g ? g.toStringTag : void 0;
function le(e) {
  var r = ge.call(e, l), t = e[l];
  try {
    e[l] = void 0;
    var o = !0;
  } catch {
  ...
  var n = fe.call(e);
  return o && (r ? e[l] = t : delete e[l]), n;
}
var pe = Object.prototype, me = pe.toString;
function be(e) {
  return me.call(e);
}
var he = "[object Null]", ke = "[object Undefined]", k = g ? g.toStringTag : void 0;
function Be(e) {
  return e == null ? e === void 0 ? ke : he : k && k in Object(e) ? le(e) : be(e);
}
function ye(e) {
...
var we = 1 / 0, B = g ? g.prototype : void 0, y = B ? B.toString : void 0;
function j(e) {
  if (typeof e == "string")
    return e;
  if (ue(e))
...
function f(e) {
  return e = je(e), e && Fe.test(e) ? e.replace(F, ie) : e;
}
function He(e) {
...
function xe(e) {
  ...
  for (const t of e)
    r.push('<div class="px-2 flex-none">›</div>'), r.push(
      `<div class="truncate"><a title="${f(t.title)}" href="${t.url}">${f(t.label)}</a></div>`
    );
  return r.join("");
}
function Ee(e, r) {
  var n;
  const t = e.nodes, o = [];
  for (let i = (n = t[r]) == null ? void 0 : n.parent; i && i !== "HomePage" && t[i]; i = t[i].parent) {
    const s = t[i];
    o.unshift({
...
var $e = function e(r, t) {
  ...
  if (r && t && typeof r == "object" && typeof t == "object") {
    ...
    if (i = Object.keys(r), o = i.length, o !== Object.keys(t).length) return !1;
    for (n = o; n-- !== 0; )
...
const Ce = $e, Ie = (e, r = Ce, { cachePromiseRejection: t = !1 } = {}) => {
  ...
  let o = !1, n, i;
  return async (...s) => (o && r(s, n) || (i = e(...s), !t && i.catch && i.catch(() => o = !1), o = !0, n = s), i);
};
var Re = Ie;
const De = /* @__PURE__ */ C(Re);
...
async function Ve(e, r = () => {
  ...
  const n = U(t, {
    ...
    htmlExtensions: [
      ...
      X({
        lead: function(a) {
          return a.type !== "containerDirective" ? !1 : (this.tag('<div class="lead">'), a.content && this.raw(a.content), this.tag("</div>"), !0);
        },
        split: function(a) {
          return a.type !== "containerDirective" ? !1 : (this.tag("<d-split>"), a.content && this.raw(a.content), this.tag("</d-split>"), !0);
        },
        aside: function(a) {
          return a.type !== "containerDirective" ? !1 : (this.tag('<div slot="right">'), a.content && this.raw(a.content), this.tag("</div>"), !0);
        },
        note: c("Note"),
        success: c("Success"),
        info: c("Info"),
        ...
        danger: c("Danger"),
        details: function(a) {
          return a.type !== "containerDirective" ? !1 : (this.tag("<details>"), this.tag("<summary>"), this.raw(a.label || "Details"), this.tag("</summary>"), a.content && this.raw(a.content), this.tag("</details>"), !0);
        },
        "*": function(a) {
          return a.content && this.raw(a.content), !0;
        }
      })
    ]
  });
...
async function Je(e, r) {
  ...
  try {
    let { vueTemplate: n, frontMatter: i } = await Ve(e, o);
    t.debuggingInfo.vueTemplate = n, t.compiled.frontMatter = i;
    {
      const u = await qe.generate(n);
      u.css && (n += `
<style scoped>${u.css}</style>`, t.debuggingInfo.vueTemplate = n), o("unocss processed");
    }
    /*!
     ...
     */
    const s = await import("./vue-repl_CC6ePg7q.js").then((u) => u.v);
    o("vue compiler imported");
    const a = { compiler: D, sfcOptions: {} }, d = {
      filename: "Note.vue",
      code: n,
      compiled: { js: "", css: "", ssr: "" }
    }, p = await s.compileFile(a, d);
    if (o("vue compiler finished"), p.length) {
      for (const u of p)
        t.errors.push(v(u));
      throw new Error("Failed to compile Vue SFC: " + p.join(", "));
    }
    t.debuggingInfo.ssrEsm = d.compiled.ssr, t.debuggingInfo.clientEsm = d.compiled.js, o("converting ssr");
    const m = await S(d.compiled.ssr, o);
    t.debuggingInfo.ssrCjs = m, o("converting js");
    ...
    const E = await V(b);
    t.compiled.html = E, o("ssr executed"), i.wide && (t.compiled.dataset.layout = "wide"), i.title && (t.compiled.title = i.title);
...
function Ke(e) {
  ...
  for (const [a, d] of Object.entries(t.dataset))
    s += ` data-${a}="${f(d)}"`;
  if (i = i.replace(/<html/, () => "<html" + s), i = i.replace(
    /<script id="head-placeholder"[^]*?<\/script>/,
    () => `<title>${f(Te(t.title))}</title>` + Pe(t.head) + (!t.css || t.css === "/* No <style> tags present */" ? "" : `<style id="note-styles">${t.css}</style>`)
  ), i = i.replace(
...
function Pe(e) {
  return e.map((r) => {
    if (r.length === 2) {
      const [t, o] = r, n = Object.entries(o).map(([i, s]) => `${i}="${f(s)}"`).join(" ");
      return `<${t} ${n} data-source="note">`;
    } else if (r.length === 3) {
      const [t, o, n] = r, i = Object.entries(o).map(([s, a]) => `${s}="${f(a)}"`).join(" ");
      return `<${t} ${i} data-source="note">${n}</${t}>`;
    }
    return "";
  }).join(`
`);
